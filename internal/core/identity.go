...
// SystemPromptBuilder constructs complete system prompts.
...
func (b *SystemPromptBuilder) Build() string {
	...
	// 2. Memory context (if any)
	if len(b.memories) > 0 {
		sb.WriteString("## Relevant Context\n\n")
		sb.WriteString("The following context from previous conversations may be relevant:\n\n")
